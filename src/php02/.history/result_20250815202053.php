            ...
            <div class="result-cards">
                <div class="result-card">
                    <div class="result-card_img-wrapper">
                        <img class="result-card_img" src="img/national_flag_img/japan.jpg<?php echo $tokyo['img'] ?> " alt="国旗">
                    </div>
                ...
                <div class="result-card">
                    <div class="result-card_img-wrapper">
                        <img class="result-card_img" src="img/national_flsg_img<?php echo $comparison['img']?> " alt="国旗">
                    </div>
                    <div class="result-card_body">
